...
function redraw(){
	...
	$(document).ready(function(){
		$("#addDraw").click(function () {
			...
			canvas1 = document.createElement('canvas1');
	...
	//Set the background color of the canvas
	context1.beginPath();
	context1.rect(drawingAreaX, drawingAreaY, drawingAreaWidth, drawingAreaHeight);
	context1.fillStyle="#fff0f5";
	context1.fill();
